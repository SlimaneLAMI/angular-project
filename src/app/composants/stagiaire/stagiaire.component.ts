...
export class StagiaireComponent implements OnInit {
  ...
  // Méthode qui sera eecutée quand Angular aura fini d'initialiser le composant
  ngOnInit(): void {
  ...
  // 2 manieres différentes pour recuperer ces valeurs respectives
  ...
  // queryParams pour /chemin?nom=Wick&prenom=John
